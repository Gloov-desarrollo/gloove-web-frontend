...
import { useNavigate } from "react-router-dom";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faUserGroup, faPhone } from "@fortawesome/free-solid-svg-icons";
import Carousel from "react-multi-carousel";
                ...
                >
                  <form name="contactForm" id="contact_form" method="post">
                    <div className="row">
                      ...
                      {/* Fechas */}
                      {/* <div className="col-lg-6 mb20" style={{ paddingRight: "0px" }}>
                        <h5 style={{ color: "white" }}>Fecha de check-in</h5>
                        <div className="date-time-field">
                          <input
                            type="text"
                      ...
                      <div className="col-lg-6 mb20" style={{ paddingLeft: "0px" }}>
                        <h5 style={{ color: "white" }}>Fecha de salida</h5>
                        <div className="date-time-field">
                          <input
                            type="text"
                    ...
                    {/* <h4 style={{ color: "white" }}>Filtros por Compañía</h4>
                    <div className="de_form">
                      {criteria.company.list.map((item, index) => (
                        <div className="de_checkbox" key={`company_${index}`}>
                          <input
                            id={`company_type_${index}`}
                            name={`company_type_${index}`}
                            type="checkbox"
                            checked={criteria.company.checked.includes(item)}
                    ...
                    <div className="de_form">
                      {criteria.features.list.map((feature, index) => (
                        <div className="de_checkbox" key={`feature_${index}`}>
                          <input
                            id={`feature_${index}`}
                            name={`feature_${index}`}
                            type="checkbox"
                  ...
                  {loading ? (
                    ...
                    filteredAccommodations.length > 0 ? (
                      filteredAccommodations.map((accom, index) => {
                        ...
                        const desc = descriptions[index];
                        return (
                          <div className="col-xl-4 col-lg-6" key={`accom_${index}`}>
                            <div className="de-item mb30">
                              <div className="d-img">
                                <img
                                  src={
